# Generated by Django 4.1.7 on 2023-03-25 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default=django.utils.timezone.now)),
                ('numLikes', models.IntegerField(blank=True, default=0)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='service.author')),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='service.post')),
            ],
        ),
    ]
